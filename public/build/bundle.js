...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  ReactDOM.render(React.createElement(InputArea, { ace: 'left-input', desc: 'ORIGINAL TEXT' }), document.getElementById('left-container'));
	  ReactDOM.render(React.createElement(InputArea, { ace: 'right-input', desc: 'CHANGED TEXT' }), document.getElementById('right-container'));
	})();
